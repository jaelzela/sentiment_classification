...
if __name__ == "__main__":
    posfeats, negfeats = feature_extraction([bag_of_words, bigram_feats, tf_idf, part_of_speech], [g2crowd], stopwords=False, punctuation=False)
    ...
    print '\ncross validation ME'
    print cross_validation(posfeats, negfeats, folds=5, classifier='maximum_entropy')
    #print '\ncross validation DT'
    ...
    #print cross_validation(posfeats, negfeats, folds=5, classifier='k_neighbors')
